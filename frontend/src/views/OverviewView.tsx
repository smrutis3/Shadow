...
export function OverviewView() {
  ...
  return (
    <div className="view">
      <div className="wf-board overview-bento">
        ...
        {totals ? (
          <div className="panel">
            <h3 className="fde-section-title">Cost & capacity</h3>
            <p className="panel-sub">AI spend is additive. The return is hours back.</p>
            <div className="totals-grid secondary stacked">
